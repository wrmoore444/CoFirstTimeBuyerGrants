"""
One-time migration script: exports articles from lib/learn.ts into articles.json.
Run: python scripts/export-articles.py
Then upload: gsutil cp articles.json gs://pivot-lending-content/articles/articles.json
"""
...
output_path = os.path.join(os.path.dirname(__file__), "..", "articles.json")
with open(output_path, "w", encoding="utf-8") as f:
    json.dump(ARTICLES, f, ensure_ascii=False, indent=2)

print(f"Wrote {len(ARTICLES)} articles to {os.path.abspath(output_path)}")
print()
print("Next step — upload to GCS:")
print("  gsutil cp articles.json gs://pivot-lending-content/articles/articles.json")
print("  gsutil acl ch -u AllUsers:R gs://pivot-lending-content/articles/articles.json")
