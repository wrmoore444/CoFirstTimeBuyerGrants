export const en = {
  ...
  about: {
    ...
    compliance: {
      ...
      nmls: 'NMLS# 109995',
      equalHousing: 'Equal Housing Lender | Equal Credit Opportunity',
      licensed: 'Pivot Financial Partners, Inc. dba Pivot Lending Group. Regulated by the Division of Real Estate (CO).',
      disclosure: 'Pivot Financial Partners, Inc. dba Pivot Lending Group. NMLS# 109995. All grant programs are subject to program availability, borrower eligibility, and lender approval. This is not a commitment to lend.',
    },
    cta: {
  ...
  contact: {
    ...
    form: {
      ...
      estimatedPurchasePricePlaceholder: 'Select a range',
  ...
  footer: {
    ...
    disclosure: 'Pivot Financial Partners, Inc. dba Pivot Lending Group. NMLS# 109995. 2009 W Littleton Blvd Ste 300, Littleton, CO 80120. Pivot does business in accordance with the Fair Housing Law and Equal Credit Opportunity Act. Regulated by the Division of Real Estate (CO). All information is subject to change. This is not a commitment to lend. Licensed in: AZ, CA, CO, CT, FL, IL, IA, KS, MA, MO, NE, NH, NJ, RI, TN, TX, WY. For full state licensing visit pivotlending.com or nmlsconsumeraccess.org.',
  },
  countiesOverview: {
