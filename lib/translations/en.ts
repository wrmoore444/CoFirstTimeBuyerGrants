export const en = {
  ...
  footer: {
    ...
    disclosure: 'CoFirstTimeBuyerGrants is a mortgage brokerage service. NMLS# [TBD]. Licensed in the State of Colorado. This is not a commitment to lend. All loans are subject to credit approval, program availability, and borrower eligibility. Homebuyer assistance programs are subject to change without notice. Equal Housing Opportunity.',
  },
  countiesOverview: {
