...
export const es: Dictionary = {
  ...
  about: {
    ...
    compliance: {
      ...
      nmls: 'NMLS# 109995',
      equalHousing: 'Prestamista de Vivienda Igualitaria | Igualdad de Oportunidad de Crédito',
      licensed: 'Pivot Financial Partners, Inc. dba Pivot Lending Group. Regulado por la División de Bienes Raíces de Colorado.',
      disclosure: 'Pivot Financial Partners, Inc. dba Pivot Lending Group. NMLS# 109995. Todos los programas de asistencia están sujetos a disponibilidad, elegibilidad del prestatario y aprobación del prestamista. Esto no es un compromiso de préstamo.',
    },
    cta: {
  ...
  footer: {
    ...
    equalHousing: 'Prestamista de Vivienda Igualitaria | Igualdad de Oportunidad de Crédito',
    nmls: 'NMLS# 109995',
    licensed: 'Pivot Financial Partners, Inc. dba Pivot Lending Group',
    copyright: 'CoFirstTimeBuyerGrants. Todos los derechos reservados.',
    disclosure: 'Pivot Financial Partners, Inc. dba Pivot Lending Group. NMLS# 109995. 2009 W Littleton Blvd Ste 300, Littleton, CO 80120. Pivot opera de acuerdo con la Ley de Vivienda Justa y la Ley de Igualdad de Oportunidades de Crédito. Regulado por la División de Bienes Raíces de Colorado. Toda la información está sujeta a cambios. Esto no es un compromiso de préstamo. Licenciado en: AZ, CA, CO, CT, FL, IL, IA, KS, MA, MO, NE, NH, NJ, RI, TN, TX, WY. Para licencias estatales completas visite pivotlending.com o nmlsconsumeraccess.org.',
  },
  countiesOverview: {
