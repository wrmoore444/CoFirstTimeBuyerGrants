        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href={`/${lang}/privacy-policy`} className="text-background/70 hover:text-primary transition-colors">{f.privacyPolicy}</Link></li>
              <li><Link href={`/${lang}/terms-conditions`} className="text-background/70 hover:text-primary transition-colors">{f.terms}</Link></li>
            </ul>
          </div>
        </div>
